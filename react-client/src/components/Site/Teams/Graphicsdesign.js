  ...
  return (
    <Stack>
            <Tabs borderColor={'primaryBlue.100'}>
                ...
                <TabPanels pt={4}>
                    <TabPanel className='removeFirstDiv' display={'flex'} alignItems={'baseline'} flexWrap={'wrap'} gap={{ base: 1, lg: 4 }} spacing={'0'} justifyContent={{ base: 'space-between', lg: 'space-between' }}>
